...
export class Nucleus06Processor {
  ...
  registerHandler(capability: Nucleus05Capability, handler: Nucleus06Handler) {
    this.handlers.set(capability, handler); return this;
  }
...
/** Compatibility alias for existing imports; one runtime only. */
